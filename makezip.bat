del Strategy.zip
"C:\Program Files\7-Zip\7z.exe" a Strategy.zip ./RussianAiCup2017.Strategy/MyStrategy.cs
"C:\Program Files\7-Zip\7z.exe" a Strategy.zip ./RussianAiCup2017.Strategy/Strategy/*.cs
