...
{
	public class ShrinkGroundVehicleFormation : VehicleFormationBase
	{
		private ScaleCommand command;

		public ShrinkGroundVehicleFormation(int id,
		...
		public override VehicleFormationResult PerformAction(World world, Player me, Game game)
		{
			...
			{
				return new VehicleFormationResult(new AttackGroundVehicleFormation(Id, VehicleIds, CommandManager, VehicleRegistry));
			}
